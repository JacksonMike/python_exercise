# Generated by Django 2.2.3 on 2019-07-28 07:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('course', models.CharField(choices=[('JavaEE', 'python人工智能'), ('前端与移动开发', '软件测试')], max_length=64, verbose_name='课程名称')),
                ...
                ('class_type', models.CharField(blank=True, choices=[('full_time', '线下班'), ('online', '网络班'), ('weekend', '周末班')], max_length=64, null=True, verbose_name='班额及类型')),
                ('campuses', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='first.Campuses', verbose_name='校区')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('qq', 'qq群'), ('referral', '内部转介绍'), ('website', '官方网站'), ('ads', '百度推广'), ('office_direct', '直接上门'), ('WoM', '口碑'), ('public_class', '公开课'), ('website', '编程猫官网'), ('others', '其它')], default='qq', max_length=64, verbose_name='客户来源')),
                ('course', multiselectfield.db.fields.MultiSelectField(choices=[('JavaEE', 'python人工智能'), ('前端与移动开发', '软件测试')], max_length=14, verbose_name='咨询课程')),
                ('class_type', models.CharField(choices=[('full_time', '线下班'), ('online', '网络班'), ('weekend', '周末班')], default='fulltime', max_length=64, verbose_name='班级类型')),
                ...
                ('class_list', models.ManyToManyField(to='first.ClassList', verbose_name='已报班级')),
                ...
                ('introduce_from', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='first.Customer', verbose_name='转介绍自学员')),
            ],
        ),
    ]
