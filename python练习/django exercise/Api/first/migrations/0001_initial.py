# Generated by Django 2.2.3 on 2019-08-18 00:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='first.Category', verbose_name='课程的分类')),
            ],
            options={
                'verbose_name': '02-课程表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_chapters', to='first.Course')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='first.Course')),
                ('recommend_courses', models.ManyToManyField(blank=True, related_name='recommend_by', to='first.Course')),
                ('teachers', models.ManyToManyField(to='first.Teacher', verbose_name='课程讲师')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='course',
            name='degree_course',
            field=models.ForeignKey(blank=True, help_text='如果是学位课程，必须关联学位表', null=True, on_delete=django.db.models.deletion.CASCADE, to='first.DegreeCourse'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='first.Account', verbose_name='会员名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_sections', to='first.CourseChapter')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_detail', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_outline', to='first.CourseDetail')),
            ],
            options={
